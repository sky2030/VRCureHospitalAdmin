       ...
       return (
        ...
        <MaterialIcons 
             ...
             <View style={styles.headerTop}>
                        <Text style={styles.headtext1}>Read the Terms & Condition Carefully </Text>
                        </View>
            <ScrollView >
             ...
             <View style={styles.card}>
                <View style={styles.header}>
                        <Text style={styles.headtext1}>Step 4 (Intellectual Property Rights) </Text>
                        </View>
                    <View style={styles.title1}>
                    <View style={styles.title2}>
                    {/* <Image 
             ...
             <View style={styles.card}>
                <View style={styles.header}>
                        <Text style={styles.headtext1}>Step 8 (Governing Law & Jurisdiction)  </Text>
                        </View>
                    <View style={styles.title1}>
                    <View style={styles.title2}>
                    {/* <Image 
